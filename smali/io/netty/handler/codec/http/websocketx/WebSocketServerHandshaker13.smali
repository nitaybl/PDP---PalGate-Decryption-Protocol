...
.method public newHandshakeResponse(Lio/netty/handler/codec/http/FullHttpRequest;Lio/netty/handler/codec/http/HttpHeaders;)Lio/netty/handler/codec/http/FullHttpResponse;
    ...
    .line 106
    invoke-static {p1}, Lio/netty/handler/codec/http/websocketx/WebSocketUtil;->sha1([B)[B
    ...
    .line 163
    .line 164
    const-string p1, "Requested subprotocol(s) not supported: {}"

    .line 165
    .line 166
    invoke-interface {p2, p1, v0}, Lio/netty/util/internal/logging/InternalLogger;->debug(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    .line 174
    invoke-virtual {p2, p1, v1}, Lio/netty/handler/codec/http/HttpHeaders;->set(Ljava/lang/CharSequence;Ljava/lang/Object;)Lio/netty/handler/codec/http/HttpHeaders;
    ...
    .line 187
    .line 188
    const-string v0, "not a WebSocket request: a |Upgrade| header must containing the value \'websocket\'"
    ...
    .line 195
    .line 196
    const-string v0, "not a WebSocket request: a |Connection| header must includes a token \'Upgrade\'"
