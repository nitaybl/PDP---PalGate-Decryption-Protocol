...
.method private static reportTooManyInstances()V
    ...
    .line 18
    .line 19
    const-string v4, " is a shared resource that must be reused across the JVM, so that only a few instances are created."

    .line 20
    .line 21
    invoke-static {v2, v1, v3, v1, v4}, Lr/p;->f(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public newTimeout(Lio/netty/util/TimerTask;JLjava/util/concurrent/TimeUnit;)Lio/netty/util/Timeout;
    ...
    .line 55
    .line 56
    invoke-static {p2, v0, p3, p4}, LA/e;->o(Ljava/lang/StringBuilder;Ljava/lang/String;J)Ljava/lang/String;
